...
class GmailExcelExtractor:
    ...
    def build_query(self, filters: EmailFilter) -> str:
        ...
        # Always search for emails with attachments
        query_parts.append("has:attachment")

        # Search for Excel files specifically
    ...
    # Download Attachment
    # ----------------------------
    def download_attachment(self, msg_id: str, attachment_id: str, filename: str, company_code: str) -> str:
        """
    ...
    def extract_all(self, filters: EmailFilter) -> ExtractionResult:
        ...
        for msg_summary in messages:
            ...
            try:
                ...
                # If sender is not mapped -> quarantine
                if not company_ctx:
                    logger.warning(
                        f"QUARANTINE: Unknown sender. from={metadata.get('from')} msg_id={msg_id}"
                    )
                    continue
